                ...
                <div class="card-body">
                    <form action="{{ route('order_detail.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="unit_price" name="unit_price" value="{{ old('unit_price', $dataorderdetail->unit_price) }}">
                            @error('address')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="qty" name="qty" value="{{ old('qty', $dataorderdetail->qty) }}">
                            @error('qty')
                            <small style="color:red,">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <a href="{{ route ('order_detail.index')}}" class="btn btn-primary">back</a>
                    </form>
